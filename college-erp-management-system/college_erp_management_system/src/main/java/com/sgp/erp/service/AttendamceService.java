...
@Service
public class AttendamceService {

    @Autowired
    private AttendanceDao attendanceDao;

    public ResponseEntity<ResponseStructure<List<Attendance>>> findByStudentId(String registrationNumber) {
        List<Attendance> attendances = attendanceDao.findByStudentId(registrationNumber);
        ...
        try {
            ...
            return new ResponseEntity<ResponseStructure<List<Attendance>>>(structure, HttpStatus.NOT_FOUND);
        } finally {
            System.out.println("finally fetched attendance!...");
        }
    }
